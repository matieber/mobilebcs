...
import static io.flutter.calificator.services.BenchmarkPreconditionIntentService.END_CHARGE_ACTION;
import static io.flutter.calificator.services.BenchmarkPreconditionIntentService.END_DISCHARGE_ACTION;
...
import io.flutter.calificator.MainActivity;
import io.flutter.calificator.benchmark.jsonConfig.BenchmarkData;
import io.flutter.calificator.benchmark.jsonConfig.BenchmarkDefinition;
import io.flutter.calificator.benchmark.jsonConfig.Variant;
import io.flutter.calificator.connection.ConnectionHandler;
import io.flutter.calificator.connection.LocalConnectionHandler;

import io.flutter.calificator.connection.ServerListener;
import io.flutter.calificator.model.UpdateData;
import io.flutter.calificator.utils.BatteryUtils;
import io.flutter.calificator.utils.CPUUtils;
import io.flutter.calificator.utils.LogGUI;
import io.flutter.calificator.utils.ScreenStateUtils;
...
public class BenchmarkExecutor extends Service implements ServerListener {
    ...
    private void initService(Intent intent) {
      ...
      //  dm = (DisplayManager) context.getSystemService(Context.DISPLAY_SERVICE);
       ...
       // filterProgressReceiver.addAction(END_BENCHMARK_ACTION);
        ...
        filterPreconditionReceiver.addAction(END_CHARGE_ACTION);
        filterPreconditionReceiver.addAction(END_DISCHARGE_ACTION);
    ...
    public static Context getBenchmarkExecutorAppContext(){
        if ( benchmarkExecutorInstance != null ){
            ...
            benchmarkExecutor.initService2();
            return benchmarkExecutor.getApplicationContext();
        }
    }
