...
import io.flutter.calificator.benchmark.BatteryStopCondition;
import io.flutter.calificator.benchmark.StopCondition;
import io.flutter.calificator.benchmark.cpuUserThread.CPUUserThread;
...
public class BenchmarkPreconditionIntentService extends IntentService {
    ...
    private static final String TAG = "BenchPrecIntentServ";
