...
public class ViewerAssertion {
    ...
    public void assertPersistedPredictionScore(List<UUID> imageSetIds, Long qualificationSession,double expectedScore) {
        ...
        for(UUID expectedCode: imageSetIds){
            ...
            Assertions.assertEquals(expectedScore,actual.get().getScore());
